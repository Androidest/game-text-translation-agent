...
3. 一个键值对是一条单独的原文样本。
#翻译规则：
1. 尽量按照术语字典中的翻译进行翻译。字典中一个术语可能有多种翻译，需要根据原文上下文选择【最合适】的翻译。
...
ERROR_NEXT_LINE = """
    ...
    请确保留跟原文一样的【显式换行标记】，不要用真换行替换'\\n'，【显式换行标记】的【数量要一致】，标记的【位置也一样】。
"""
...
ERROR_NEXT_LINE_R = """
    ...
    请确保留跟原文一样的【显式换行标记】，不要用真换行替换'\\r'，【显式换行标记】的【数量要一致】，标记的【位置也一样】。
"""
